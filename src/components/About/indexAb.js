...
import SpringIcon from '../About/SpringIconBG.png'
    ...
    return (
        ...
        <div className="container about-page">
            <div className='text-zone'>
                ...
                <p> I’m a passionate and driven Full Stack Developer with a strong foundation in both frontend and backend technologies. I’m actively seeking opportunities to contribute to impactful projects in the tech industry while continuously learning and growing as a developer.


                </p>
                <p>I thrive in fast-paced environments, enjoy solving complex problems, and am always curious about exploring new technologies. My approach blends creativity, precision, and a relentless drive for self-improvement.</p>
            ...
            <div className='stage-cube-cont'>
                <div className='cubespinner'>
                    ...
                    <div className='face2'>
                        {/* <FontAwesomeIcon icon={faS} size='4x' color='#f0870f' /> */}
                        <img src={SpringIcon} 
                        alt="Spring"
                        color='#f0870f'
                    ...
                    <div className='face3'>
                        <FontAwesomeIcon icon={faNodeJs} size='4x' color='#2307ab' />

                    </div>
                    <div className='face4'>
                        <FontAwesomeIcon icon={faJava} size='4x' color='#DD0101' />

                    </div>
                    <div className='face6'>
                    {/* <FontAwesomeIcon icon={faDatabase} size='4x' color='#DD0101'  /> */}
                    <FontAwesomeIcon icon={faDatabase} size='4x' color='#DD0101' style={{ transform: 'rotate(-90deg)' }} />
